...
systemd:
	uvx --from=flask-nginx footprint config template -o emma-annotator.service etc/emma-annotator.service \
...
install:
	uvx --from=flask-nginx footprint config systemd-install emma-annotator.service
uninstall:
	uvx --from=flask-nginx footprint config systemd-uninstall emma-annotator.service
